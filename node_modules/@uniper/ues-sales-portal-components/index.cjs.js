...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$e(fn = input.toString) && !isObject$b(val = call$c(fn, input))) return val;
  if (isCallable$e(fn = input.valueOf) && !isObject$b(val = call$c(fn, input))) return val;
  if (pref !== 'string' && isCallable$e(fn = input.toString) && !isObject$b(val = call$c(fn, input))) return val;
...
var NEW_ITERATOR_PROTOTYPE = !isObject$6(IteratorPrototype$2) || fails$c(function () {
  var test = {};
...
UNSUPPORTED_Y$2 || fails$a(function () {
...
var speciesConstructor$1 = function (O, defaultConstructor) {
  ...
  var S;
  return C === undefined || isNullOrUndefined$2(S = anObject$3(C)[SPECIES]) ? defaultConstructor : aConstructor(S);
};
  ...
  return [
    ...
    function split(separator, limit) {
      ...
      return splitter
        ...
        : call$3(internalSplit, toString$3(O), separator, limit);
    },
...
const defaultContext$4 = {
  ...
  notification: {
    onDuplicateValues: () => undefined,
    onInvalidValues: () => undefined
  }
};
const Context$5 = /*#__PURE__*/React.createContext(defaultContext$4);
const ChipAutocompleteProvider = ({
  translation,
  notification,
  children
}) => jsxRuntime.jsx(Context$5, {
  value: {
    translation,
    notification
  },
...
const useChipAutocomplete = () => {
  const context = React.use(Context$5);
  if (!context || context === defaultContext$4) {
    throw new Error('Missing ChipAutocompleteProvider');
  }
  return context;
};

const EXCEL_SEPARATOR_REGEX = /\s*[\r\n\t,;]+\s*/g;
const ChipAutocomplete = /*#__PURE__*/React.forwardRef((props, propRef) => {
  const {
      value = [],
      error,
      chipTypingPattern,
      chipValuePattern,
      separatorPattern = EXCEL_SEPARATOR_REGEX,
      maxChipCount,
      onChipClick,
      label,
      options,
      onBeforePaste = clipboardData => clipboardData,
      getOptionLabel = option => option,
      onChange,
      freeSolo
    } = props,
    otherProps = tslib.__rest(props, ["value", "error", "chipTypingPattern", "chipValuePattern", "separatorPattern", "maxChipCount", "onChipClick", "label", "options", "onBeforePaste", "getOptionLabel", "onChange", "freeSolo"]);
  const theme = material.useTheme();
  const maxChipCountReached = maxChipCount && value.length >= maxChipCount;
  const {
    translation: {
      placeholder,
      placeholderMaxItems
  ...
  return jsxRuntime.jsx(material.ThemeProvider, {
    theme: theme,
    children: jsxRuntime.jsx(material.Autocomplete, Object.assign({}, otherProps, {
      freeSolo: freeSolo !== null && freeSolo !== void 0 ? freeSolo : true,
      ref: propRef,
      value: value,
      onChange: onChange,
      multiple: true,
      ...
      onPaste: event => {
        ...
        try {
          if (onChange) {
            ...
            const pasted = onBeforePaste(clipboardData).split(separatorPattern);
            const {
              result,
              invalid,
              duplicate
            } = processPastedValues(pasted, value, chipValuePattern);
            if (result.length > value.length) {
              onChange(event, result, 'createOption');
            }
            if (invalid.length) {
              onInvalidValues(invalid, filtered(invalid, 0));
            }
            if (duplicate.length) {
              onDuplicateValues(duplicate, filtered(duplicate, 1));
            }
          }
        } catch (e) {
          console.error(e);
      ...
      options: options || [],
      renderValue: (values, getItemProps) => values.map((option, index) => {
        const itemProps = getItemProps({
          index
        });
        return /*#__PURE__*/React.createElement(material.Chip, Object.assign({
      ...
      renderInput: params => jsxRuntime.jsx(material.TextField, Object.assign({}, params, {
        label: label,
        "aria-label": props['aria-label'],
        error: error,
        placeholder: maxChipCountReached ? placeholderMaxItems(maxChipCount) : placeholder,
        slotProps: {
          input: Object.assign(Object.assign({}, params.InputProps), {
            inputProps: Object.assign(Object.assign({}, params.inputProps), {
              disabled: params.disabled || maxChipCountReached,
              onBlur: e => e.target.dispatchEvent(keyDownEnter()),
              onKeyDown: ({
                key
              }) => {
                const item = params.inputProps.value;
                if (key === 'Enter' && value.includes(item)) {
                  const occurrences = [{
                    item,
                    occurrences: 1
                  }];
                  onDuplicateValues(occurrences, item);
                }
              },
              onChange: e => {
                if (params.inputProps.onChange && (chipTypingPattern && e.target.value.match(chipTypingPattern) || !chipTypingPattern)) {
...
const processPastedValues = (pasted, value, validPattern) => {
  const isValid = item => !lodashExports.isNil(item) && !lodashExports.isEmpty(item) && (validPattern ? item.match(validPattern) : true);
  const [valid, invalid] = lodashExports.partition(pasted, isValid);
  const all = lodashExports.concat(value, valid);
  const [duplicate] = lodashExports.partition(lodashExports.entries(lodashExports.countBy(all)), ([_, occurrences]) => occurrences > 1);
  return {
    result: lodashExports.uniq(all),
    invalid: lodashExports.entries(lodashExports.countBy(invalid)).map(([item, occurrences]) => ({
      item,
      occurrences
    })),
    duplicate: duplicate.map(([item, occurrences]) => ({
      item,
      occurrences
    }))
  };
};
const filtered = (items, keeping) => items.map(({
  item,
  occurrences
}) => `${occurrences - keeping}x[${item}]`).join(', ');

const defaultContext$3 = {
  translation: {
    atMostOneEnumMessage: '',
    defaultRenderItem: () => ''
  }
};
const Context$4 = /*#__PURE__*/React.createContext(defaultContext$3);
const EnumSelectTranslationProvider = ({
  translation,
  children
}) => jsxRuntime.jsx(Context$4.Provider, {
  value: {
    translation
  },
  children: children
...
const useEnumSelect = () => {
  const context = React.useContext(Context$4);
  if (!context || context === defaultContext$3) {
    throw new Error('Missing EnumSelectTranslationProvider');
  }
  return context;
};
...
const Context$3 = /*#__PURE__*/React.createContext(defaultValue);
const DisableFieldsTranslationProvider = ({
  defaultMessage,
  children
}) => jsxRuntime.jsx(Context$3, {
  value: {
    defaultMessage
  },
  children: children
});
const useDisableFieldsTranslation = () => {
  const context = React.use(Context$3);
  if (!context || context === defaultValue) throw new Error('Missing DisableFieldsTranslationProvider');
  return context;
};

const getActiveDisableRule = rules => rules.reduce((acc, rule) => !acc && rule.disabled ? rule : acc, null);

const DisabledFieldsContext = /*#__PURE__*/React.createContext({
  activeRule: null
});
const DisabledFieldsContextProvider = ({
  children,
  activeRule
}) => {
  return jsxRuntime.jsx(DisabledFieldsContext, {
    value: {
      activeRule
    },
    children: children
...
const useDisabledFieldContext = () => React.use(DisabledFieldsContext);

const notDisabled = {
  disabled: false
};
/**
 * Disables all form controls that are wrapped within
 * WARNING - This component should NOT be used to disable single form controls (buttons, inputs, etc.)
 * Use DisabledFormControlTooltip instead and disable your desired form control directly
 * There is significant performance penalty using this component and it is meant for disabling multiple form controls at once
 * @param children - The form controls to be disabled
 * @param rules - An array of rules that determine if the fields should be disabled
 * @param fullWidth - If true, the fields will be displayed in full width
 */
const DisableFields = ({
  children,
  rules,
  ...
  var _a;
  const theme = material.useTheme();
  const disabledTheme = useDisabledTheme(theme);
  const activeRule = getActiveDisableRule(rules);
  const {
    defaultMessage
  } = useDisableFieldsTranslation();
  const {
    activeRule: parentActiveRule
  } = useDisabledFieldContext();
  if (parentActiveRule || !activeRule) return children;
  return jsxRuntime.jsx(material.ThemeProvider, {
    theme: disabledTheme,
    children: jsxRuntime.jsx(DisabledFieldsContextProvider, {
      activeRule: activeRule,
      children: jsxRuntime.jsx(material.Tooltip, {
        title: (_a = activeRule === null || activeRule === void 0 ? void 0 : activeRule.message) !== null && _a !== void 0 ? _a : defaultMessage,
        children: jsxRuntime.jsx(material.Box, {
          component: "span",
          sx: {
            display: 'inline-block',
            height: 'inherit',
            width: _fullWidth ? '100%' : 'inherit'
          },
          children: jsxRuntime.jsx(material.Box, {
            component: "fieldset",
            disabled: true,
...
const COMPONENTS_2_DISABLE = ['MuiButton', 'MuiTextField', 'MuiAutocomplete', 'MuiSelect', 'MuiCheckbox', 'MuiIconButton', 'MuiInputBase', 'MuiButtonGroup', 'MuiToggleButton', 'MuiToggleButtonGroup', 'MuiFormControlLabel'];
const disabledThemeFactory = theme => {
  const disabledTheme = material.createTheme(theme);
  const disabledComponents = COMPONENTS_2_DISABLE.reduce((acc, componentName) => {
    return Object.assign(Object.assign({}, acc), disableComponent(componentName, disabledTheme));
  }, {});
  disabledTheme.components = Object.assign(Object.assign(Object.assign({}, disabledTheme.components), disabledComponents), {
    MuiInputAdornment: Object.assign(Object.assign({}, theme.components ? theme.components.MuiInputAdornment : {}), {
      styleOverrides: {
        root: {
          color: 'inherit'
        }
    ...
    MuiInputLabel: Object.assign(Object.assign({}, theme.components ? theme.components.MuiInputLabel : {}), {
      styleOverrides: {
        root: {
    ...
    MuiFormControlLabel: Object.assign(Object.assign({}, disabledComponents['MuiFormControlLabel']), {
      styleOverrides: {
        root: {
          cursor: 'default !important'
        }
    ...
    MuiTypography: Object.assign(Object.assign({}, theme.components ? theme.components.MuiTypography : {}), {
      styleOverrides: {
        root: {
    ...
    MuiCheckbox: Object.assign(Object.assign({}, disabledComponents['MuiCheckbox']), {
      styleOverrides: {
        root: {
          pointerEvents: 'none',
          // TODO: Vermutlich Mui-Problem, dass das disabled Prop nicht richtig verarbeitet wird für MuiCheckbox
          color: theme.palette.text.disabled
        }
      }
    }),
    MuiAutocomplete: Object.assign(Object.assign({}, disabledComponents['MuiAutocomplete']), {
      styleOverrides: {
        popupIndicator: {
          color: `inherit`
        }
...
const disableComponent = (componentName, theme) => {
  var _a, _b;
  return {
    [componentName]: Object.assign(Object.assign({}, theme.components ? theme.components[componentName] : {}), {
      defaultProps: Object.assign(Object.assign({}, theme.components && ((_a = theme.components[componentName]) === null || _a === void 0 ? void 0 : _a.defaultProps) ? (_b = theme.components[componentName]) === null || _b === void 0 ? void 0 : _b.defaultProps : {}), {
        disabled: true
      })
    })
  };
};
const useDisabledTheme = theme => {
  return React.useMemo(() => disabledThemeFactory(theme), [theme]);
};

const EnumSelectComponent = (_a, ref) => {
  var {
      value,
      onChange,
      enumName,
    ...
    otherProps = tslib.__rest(_a, ["value", "onChange", "enumName", "enumType", "emptyOption", "disabledOptions", "disabled", "renderOption"]);
  const {
    translation: {
      atMostOneEnumMessage,
      defaultRenderItem
  ...
  const theme = material.useTheme();
  const render = renderOption !== null && renderOption !== void 0 ? renderOption : defaultRenderItem;
  const atMostOneEnum = Object.entries(enumType).length - disabledOptions.length < 2;
  const isTextFieldDisabled = atMostOneEnum ? [{
    disabled: atMostOneEnum,
    message: atMostOneEnumMessage
  }] : [];
  return jsxRuntime.jsx(material.ThemeProvider, {
    theme: theme,
    children: jsxRuntime.jsx(DisableFields, {
      rules: isTextFieldDisabled,
      children: jsxRuntime.jsxs(material.TextField, Object.assign({
        select: true,
        // workaround until MUI correctly sets error state on MuiSelect component to style icon in correct color
        sx: theme => ({
        ...
        ref: ref,
        disabled: atMostOneEnum || disabled
      }, otherProps, {
        value: value !== null && value !== void 0 ? value : '',
        onChange: event => onChange(event.target.value),
        children: [emptyOption && jsxRuntime.jsx(material.MenuItem, {
          value: "",
          children: "-"
        }), Object.entries(enumType).map(([key, value]) => jsxRuntime.jsx(material.MenuItem, {
          value: value,
          disabled: disabledOptions.includes(value),
          children: render(enumName, key)
        }, `${enumName}-${key}`))]
      }))
    })
  });
};
const EnumSelect = /*#__PURE__*/React.forwardRef(EnumSelectComponent);

const defaultContext$2 = {
  translation: {
    enumsPrefixTranslations: () => ''
  }
};
const Context$2 = /*#__PURE__*/React.createContext(defaultContext$2);
const EnumButtonGroupTranslationProvider = ({
  translation,
  children
}) => jsxRuntime.jsx(Context$2.Provider, {
  value: {
    translation
  },
  children: children
});
const useEnumButtonGroup = () => {
  const context = React.useContext(Context$2);
  if (!context || context === defaultContext$2) {
    throw new Error('Missing EnumButtonGroupTranslationProvider');
  }
  return context;
};

const EnumButtonGroupComponent = (_a, ref) => {
  var {
      label,
      value,
      onChange,
    ...
    otherProps = tslib.__rest(_a, ["label", "value", "onChange", "enumName", "enumType", "disabledOptions", "autoFocus"]);
  const {
    translation: {
      enumsPrefixTranslations
    }
  } = useEnumButtonGroup();
  const findDisabledOption = enumValue => disabledOptions === null || disabledOptions === void 0 ? void 0 : disabledOptions.find(({
    value
  }) => enumValue === value);
  return jsxRuntime.jsxs(material.FormControl, {
    fullWidth: true,
    children: [label && jsxRuntime.jsx(material.FormLabel, {
      children: label
    }), jsxRuntime.jsx(material.ToggleButtonGroup, Object.assign({}, otherProps, {
      fullWidth: true,
      exclusive: true,
      ref: ref,
      value: value,
      onChange: (_event, value) => onChange(value || undefined),
      children: Object.entries(enumType).map(([enumKey, enumValue]) => {
        var _a;
        return jsxRuntime.jsx(material.Tooltip, {
          title: (_a = findDisabledOption(enumValue)) === null || _a === void 0 ? void 0 : _a.tooltip,
          children: jsxRuntime.jsx(material.Box, {
            sx: {
              display: 'inherit',
              width: '100%'
            },
            children: jsxRuntime.jsx(material.ToggleButton, {
              fullWidth: true,
              value: enumValue !== null && enumValue !== void 0 ? enumValue : '',
              "aria-label": enumsPrefixTranslations(`${enumName}.${enumKey}`),
              disabled: !!findDisabledOption(enumValue),
              autoFocus: autoFocus && !findDisabledOption(enumValue),
              children: enumsPrefixTranslations(`${enumName}.${enumKey}`)
            })
          })
        }, `${enumName}-${enumKey}`);
      })
...
const EnumButtonGroup = /*#__PURE__*/React.forwardRef(EnumButtonGroupComponent);
...
const ConfirmationDialog = ({
  open,
  onAbort: _onAbort = noop$2,
  onConfirm,
  title,
  description,
  content,
  variant: _variant = 'confirmation',
  translation
}) => {
  var _a, _b, _c, _d, _e, _f;
  const t = translation[_variant];
  if (!t) {
    throw new Error(`Missing translation for ConfirmationDialog variant: ${_variant}`);
  }
  return jsxRuntime.jsxs(material.Dialog, {
    ...
    children: [jsxRuntime.jsx(material.DialogTitle, {
      ...
      children: [jsxRuntime.jsx(material.Button, {
        onClick: _onAbort,
        "aria-label": (_c = (_b = (_a = t.abort).ariaLabel) === null || _b === void 0 ? void 0 : _b.call(_a, title)) !== null && _c !== void 0 ? _c : t.abort.label,
        variant: "text",
        children: t.abort.label
      }), jsxRuntime.jsx(material.Button, {
        onClick: onConfirm,
        variant: "text",
        color: "secondary",
        "aria-label": (_f = (_e = (_d = t.confirm).ariaLabel) === null || _e === void 0 ? void 0 : _e.call(_d, title)) !== null && _f !== void 0 ? _f : t.confirm.label,
        autoFocus: true,
...
const emptyConfirmationDialogProps = {
  onAbort: noop$2,
  onConfirm: noop$2,
  description: '',
  title: ''
...
const ConfirmationDialogProvider = ({
  ...
  const [config, setConfig] = React.useState(emptyConfirmationDialogProps);
  const doOpen = config => {
    setConfig(config);
    setOpen(true);
  };
  return jsxRuntime.jsxs(ConfirmationDialogContext, {
    value: {
      doOpen
    },
    children: [jsxRuntime.jsx(ConfirmationDialog, Object.assign({}, config, {
      open: open,
      onConfirm: () => {
        config.onConfirm();
        setOpen(false);
      ...
      onAbort: () => {
        var _a;
        (_a = config.onAbort) === null || _a === void 0 ? void 0 : _a.call(config);
        setOpen(false);
      },
...
const useConfirmationDialog = props => {
  const {
    doOpen
  } = React.use(ConfirmationDialogContext);
  return {
    show: config => doOpen(Object.assign(Object.assign({}, props), config))
  };
};

const DisabledFormControlTooltip = _a => {
  var {
      children,
      rules,
      fullWidth = true
    } = _a,
    rest = tslib.__rest(_a, ["children", "rules", "fullWidth"]);
  const {
    activeRule: parentActiveRule
  } = useDisabledFieldContext();
  if (parentActiveRule) return children;
  const activeRule = getActiveDisableRule(rules);
  return activeRule ? jsxRuntime.jsx(DisabledFieldsContextProvider, {
    activeRule: activeRule,
    children: jsxRuntime.jsx(material.Tooltip, Object.assign({
      title: activeRule === null || activeRule === void 0 ? void 0 : activeRule.message
    }, rest, {
      children: jsxRuntime.jsx(material.Box, {
        component: "span",
        sx: {
...
const Context$1 = /*#__PURE__*/React.createContext(defaultContext$1);
const PortalContextProvider = ({
  portalContext,
  children
}) => jsxRuntime.jsx(Context$1, {
  value: portalContext,
  children: children
});
const usePortalContext = () => {
  const portalContext = React.use(Context$1);
  if (!portalContext || portalContext === defaultContext$1) {
    throw new Error('Missing PortalContextProvider');
  }
...
const ErrorBoundary = ({
  ...
  return jsxRuntime.jsx(CustomErrorBoundaryComponent, {
    services: services,
    children: children
  });
};
class CustomErrorBoundaryComponent extends React.Component {
  constructor(props) {
    super(props);
    this._logger = props.services.logging;
    this._monitor = props.services.monitoring;
    this.state = {
      hasError: false
    };
  }
  ...
  componentDidCatch(error, errorInfo) {
    this._monitor.reportError(error);
    this._logger.error(error.name, error.message, error.stack, errorInfo.componentStack, window.location.href);
  }
  render() {
    return this.state.hasError ? jsxRuntime.jsx(material.Box, {
      sx: {
        margin: 'auto',
        userSelect: 'none',
        fontSize: '42px',
      ...
      children: jsxRuntime.jsxs("div", {
        children: [jsxRuntime.jsx(material.Box, {
          ...
          children: ["Oops \u2026 something went ", jsxRuntime.jsx("b", {
            children: "t-rex"
          }), "ibly wrong."]
        })]
      })
...
const updatePreferences = (currentVersion, transformers, preferences) => {
  if (currentVersion - 1 !== transformers.length) {
    console.warn('userPreferenceHookFactory: The number of transformers does not match the current version of the preferences object.');
    return undefined;
  }
  if ((preferences === null || preferences === void 0 ? void 0 : preferences.version) && currentVersion > (preferences === null || preferences === void 0 ? void 0 : preferences.version) && (transformers === null || transformers === void 0 ? void 0 : transformers.length)) {
    return transformers === null || transformers === void 0 ? void 0 : transformers.slice((preferences === null || preferences === void 0 ? void 0 : preferences.version) - 1).reduce((acc, transformer) => transformer(acc), preferences);
  } else {
    return preferences;
  }
};
 ...
 */
const userPreferenceHookFactory = (version = 1, transformers = []) => (preferenceName, defaultValue) => {
  const {
    services: {
      userPreferences
    }
  } = usePortalContext();
  const versionedCurrentPreference = updatePreferences(version, transformers, userPreferences.getPreferences());
  const preferenceObject = versionedCurrentPreference === null || versionedCurrentPreference === void 0 ? void 0 : versionedCurrentPreference.preferences;
  const storedPreferenceValue = preferenceObject === null || preferenceObject === void 0 ? void 0 : preferenceObject[preferenceName];
  const preference = storedPreferenceValue !== null && storedPreferenceValue !== void 0 ? storedPreferenceValue : defaultValue;
  const setPreference = React.useCallback(value => userPreferences.updatePreferences(previous => ({
    version,
    preferences: Object.assign(Object.assign({}, previous === null || previous === void 0 ? void 0 : previous.preferences), {
      [preferenceName]: value
    })
  })), [preferenceName, userPreferences]);
  const clearPreference = React.useCallback(() => userPreferences.updatePreferences(previous => {
    var _a;
    const _b = (_a = previous === null || previous === void 0 ? void 0 : previous.preferences) !== null && _a !== void 0 ? _a : {},
      _c = preferenceName;
      _b[_c];
      const otherPreferences = tslib.__rest(_b, [typeof _c === "symbol" ? _c : _c + ""]);
    return {
      version,
  ...
  return {
    ...
    setPreference,
    clearPreference,
    fallbackValueUsed: storedPreferenceValue === undefined
  };
};
...
const DynamicPortal = ({
  ...
  const contentHidden = useHideContent({
    container,
    hideExistingContent
  });
  if (!contentHidden && hideExistingContent) return null;
  if (!children || !container) return null;
  return jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: /*#__PURE__*/ReactDOM.createPortal(children, container)
  });
};
const useHideContent = ({
  ...
  React.useEffect(() => {
    const hiddenObjects = [];
    if (hideExistingContent && container) {
    ...
    return () => {
      hiddenObjects.forEach(it => {
        it.element.style.display = it.display;
      });
      setContentHidden(false);
    };
  }, [container, hideExistingContent]);
  return contentHidden;
};

const ActionPortalsContext = /*#__PURE__*/React.createContext({
  PrimaryActionArea: () => null,
  SecondaryActionArea: () => null
});
const ActionPortalsContextProvider = ({
  children,
  primaryContainerElement,
  secondaryContainerElement
}) => jsxRuntime.jsx(ActionPortalsContext, {
  value: {
    PrimaryActionArea: ({
      children,
      hideExisting
    }) => jsxRuntime.jsx(DynamicPortal, {
      container: primaryContainerElement,
      hideExistingContent: hideExisting,
      children: children
    }),
    SecondaryActionArea: ({
      children,
      ...
      container: secondaryContainerElement,
      hideExistingContent: hideExisting,
      children: children
    })
  },
...
const useActionPortals = () => React.use(ActionPortalsContext);

const ActionRefContext = /*#__PURE__*/React.createContext({
  primaryRef: () => () => {
    // empty
  },
  secondaryRef: () => () => {
...
const ActionRefContextProvider = ({
  children
}) => {
  ...
  const secondaryRef = React.useCallback(node => {
    setSecondary(node);
    return () => setSecondary(null);
  }, []);
  return jsxRuntime.jsx(ActionRefContext, {
    value: {
      primaryRef,
      secondaryRef,
...
const useActionRefContext = () => React.use(ActionRefContext);

const NavigationLayout = ({
  children
}) => jsxRuntime.jsx(material.Paper, {
  sx: {
    height: '100%',
    width: '100%',
    overflow: 'hidden'
  ...
  children: jsxRuntime.jsx(material.Box, {
    ...
    children: jsxRuntime.jsx(ActionRefContextProvider, {
      children: children
    })
  })
});
...
const NavigationDrawer = ({
  ...
  return jsxRuntime.jsx(material.Box, {
    ...
    sx: theme => ({
      ...
      maxWidth: '600px',
      width: '25vw',
      color: theme.palette.uniper.navigation.active
    }),
    children: jsxRuntime.jsx(material.List, {
      component: "ol",
      sx: {
        display: 'flex',
        flexFlow: 'column',
...
const getWindowDimensions = () => {
  var _a, _b, _c, _d;
  return {
    width: (_b = (_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.window) === null || _a === void 0 ? void 0 : _a.innerWidth) !== null && _b !== void 0 ? _b : 1000,
    height: (_d = (_c = globalThis === null || globalThis === void 0 ? void 0 : globalThis.window) === null || _c === void 0 ? void 0 : _c.innerHeight) !== null && _d !== void 0 ? _d : 1000
  };
};
const useWindowDimensions = () => {
  ...
  React.useEffect(() => {
    ...
    (_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.window) === null || _a === void 0 ? void 0 : _a.addEventListener('resize', handleResize);
    return () => {
      var _a;
      return (_a = globalThis === null || globalThis === void 0 ? void 0 : globalThis.window) === null || _a === void 0 ? void 0 : _a.removeEventListener('resize', handleResize);
    };
  }, []);
...
const NavigationHeader = ({
  ...
  status,
  additionalInfo,
  showAdditionalInfoAsTooltip
}) => {
  const {
    height: windowHeight
  } = useWindowDimensions();
  const showAsTooltip = showAdditionalInfoAsTooltip !== null && showAdditionalInfoAsTooltip !== void 0 ? showAdditionalInfoAsTooltip : windowHeight < 750;
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [(appIcon || appName || status) && jsxRuntime.jsx(material.ListItem, {
      sx: theme => ({
        height: theme.spacing(7.5),
        backgroundColor: 'rgba(0, 0, 0, 0.15)'
      }),
      children: jsxRuntime.jsxs(material.Grid, {
        container: true,
        ...
        children: [jsxRuntime.jsxs(material.Grid, {
          ...
          alignItems: "center",
          spacing: 1,
          children: [appIcon && jsxRuntime.jsx(material.Grid, {
            children: jsxRuntime.jsx(DisplayIcon, {
              appIcon: appIcon,
              appIconColor: appIconColor
            })
          }), jsxRuntime.jsx(material.Grid, {
            children: jsxRuntime.jsx(WithBackdrop, {
              children: jsxRuntime.jsxs(material.Grid, {
                container: true,
                alignItems: "center",
                spacing: 1,
                children: [jsxRuntime.jsx(material.Grid, {
                  children: appName
                }), showAsTooltip && additionalInfo && jsxRuntime.jsx(material.Grid, {
                  children: jsxRuntime.jsx(AdditionalInfoTooltip, {
    ...
    }), !showAsTooltip && additionalInfo && jsxRuntime.jsx(material.Box, {
      sx: theme => ({
        paddingTop: theme.spacing(2)
      }),
      children: jsxRuntime.jsx(NavigationPage.Item, {
        children: additionalInfo
      })
    })]
  });
...
const DisplayIcon = ({
  appIcon,
  appIconColor
}) => appIcon && jsxRuntime.jsx(material.Box, {
  sx: theme => ({
    color: 'white',
    backgroundColor: appIconColor !== null && appIconColor !== void 0 ? appIconColor : theme.palette.primary.main,
...
const WithBackdrop = ({
  ...
  sx: theme => ({
    color: 'white',
    backgroundColor: material.alpha(theme.palette.grey.A200, 0.15),
...
const AdditionalInfoTooltip = ({
  ...
  title: jsxRuntime.jsx(material.Box, {
    sx: {
      pointerEvents: 'auto'
    },
    children: children
  ...
  children: jsxRuntime.jsx(material.Box, {
    ...
    children: jsxRuntime.jsx(material.Icon, {
      className: "ico-online-circle-info"
    })
  })
});
...
const NestedNavigation = ({
  children,
  sx
}) => jsxRuntime.jsx(material.ListItem, {
  className: "nested",
  sx: theme => ({
    flex: '1 1 1',
    overflow: 'auto',
    ...
    paddingY: 0,
    '.nested': {
      backgroundColor: 'transparent !important' // Only colorize top-most .nested
    },
    '&:has(.NavigationItem--active)': {
      backgroundColor: 'rgba(255, 255, 255, 0.1)',
      '& > ol': {
        backgroundColor: 'transparent !important' // Disable background-color: inherit for nested lists
      }
    },
    '.NavigationItem--active': {
      backgroundColor: 'transparent' // Do not colorize background when within a nested navigation
    }
  }),
  children: jsxRuntime.jsx(material.List, {
    component: "ol",
...
const NavigationItemContext = /*#__PURE__*/React.createContext(undefined);
const NavigationItemProvider = ({
  children,
  isActive
}) => {
  const parentContext = React.use(NavigationItemContext);
  return jsxRuntime.jsx(NavigationItemContext, {
    value: {
      isActive,
...
const useNavigationItemContext = () => {
  const context = React.use(NavigationItemContext);
  if (context === undefined) throw new Error('NavigationItemBullet and NavigationItemContent can only be used inside of a NavigationItem!');
  return context;
};
...
const NavigationItem = ({
  ...
  className: _isActive ? 'NavigationItem--active' : '',
  sx: theme => ({
    display: 'flex',
    gap: theme.spacing(),
    alignItems: 'center',
    backgroundColor: _isActive ? 'rgba(255, 255, 255, 0.1)' : ''
  }),
  secondaryAction: secondaryAction,
  children: jsxRuntime.jsx(NavigationItemProvider, {
    isActive: _isActive,
    children: children
  })
});
...
var AvatarSize;
(function (AvatarSize) {
  AvatarSize[AvatarSize["SMALL"] = 16] = "SMALL";
  AvatarSize[AvatarSize["REGULAR"] = 24] = "REGULAR";
})(AvatarSize || (AvatarSize = {}));
var AvatarType;
(function (AvatarType) {
  AvatarType["NUMERIC"] = "NUMERIC";
  AvatarType["ALPHABETIC"] = "ALPHABETIC";
})(AvatarType || (AvatarType = {}));
const errorBullet = '!';
const transparentColor = 'transparent';
/**
 * Bullet point for the NavigationItem. Must be wrapped in a NavigationItem or it will throw an Error.
 * @throws Error if used outside of a NavigationItem.
 * @param bulletValue
 * @param error
 * @param ghost
 * @param avatarSize
 * @param avatarType
 * @param overrideIsActive
 * @constructor
 */
const NavigationItemBullet = ({
  bulletValue,
  error: _error = false,
  ghost: _ghost = false,
  avatarSize,
  avatarType: _avatarType = AvatarType.NUMERIC,
  ...
  const isActive = overrideIsActive !== null && overrideIsActive !== void 0 ? overrideIsActive : itemActive;
  const bullet = bulletValue !== undefined ? _avatarType === AvatarType.NUMERIC ? bulletValue : convertIdx2Alphabetic(bulletValue) : ' ';
  const size = avatarSize || nested ? AvatarSize.SMALL : AvatarSize.REGULAR;
  const borderWidth = avatarSize || nested ? '1px' : '2px';
  const bulletFontSize = size === AvatarSize.REGULAR ? '1rem' : '0.75rem';
  const backgroundColor = theme.palette.uniper.navigation.backgroundColor;
  const activeColor = theme.palette.uniper.navigation.active;
  const errorColor = theme.palette.error.main;
  const white = theme.palette.common.white;
  const ghostStyle = {
    bgcolor: transparentColor,
    color: _error ? errorColor : isActive ? activeColor : white,
    borderStyle: isActive ? 'dashed' : 'dotted'
  };
  const standardStyle = {
    bgcolor: _error ? errorColor : isActive ? activeColor : transparentColor,
    color: isActive ? backgroundColor : white,
    borderStyle: 'solid'
  };
  return jsxRuntime.jsx(material.ListItemAvatar, {
    sx: {
      minWidth: 'unset'
    },
    children: jsxRuntime.jsx(material.Avatar, {
      sx: Object.assign({
        width: size,
        height: size,
        ...
        borderColor: _error ? errorColor : isActive ? activeColor : white,
        paddingTop: '2px'
      }, _ghost ? ghostStyle : standardStyle),
      "aria-label": "bullet-point-value",
      children: _error ? errorBullet : bullet
    })
  });
};
const convertIdx2Alphabetic = idx => String.fromCharCode('a'.charCodeAt(0) + idx);

/**
 * Content for the NavigationItem. Must be wrapped in a NavigationItem or it will throw an Error.
 * @param children
 * @param isActive
 * @constructor
 */
const NavigationItemContent = ({
  ...
  const isActive = overrideIsActive !== null && overrideIsActive !== void 0 ? overrideIsActive : itemActive;
  return jsxRuntime.jsx(material.ListItemText, {
    sx: theme => ({
      color: theme.palette.uniper.navigation.active
    }),
    primary: jsxRuntime.jsx(material.Box, {
      component: "span",
      sx: theme => ({
        userSelect: 'none',
...
const MainPanel = ({
  ...
  return jsxRuntime.jsx(material.Box, {
    ...
    children: jsxRuntime.jsx(ActionPortalsContextProvider, {
      primaryContainerElement: primaryElement,
      secondaryContainerElement: secondaryElement,
      children: children
    })
  });
};
...
const NavigationPage = {
  ...
  Nested: NestedNavigation,
  Item: NavigationItem,
  ItemBullet: NavigationItemBullet,
...
const useNavigationActionAreas = useActionPortals;

const defaultContext = {
  missingRoleMessage: () => ''
};
const Context = /*#__PURE__*/React.createContext(defaultContext);
const RBACTranslationProvider = ({
  missingRoleMessage,
  children
}) => jsxRuntime.jsx(Context, {
  value: {
    missingRoleMessage
  },
  children: children
});
const useRBACTranslation = () => {
  const context = React.useContext(Context);
  if (!context || context === defaultContext) {
    throw new Error('Missing RBACTranslationProvider');
  }
  return context;
};

/**
 * Check if the currently logged-in user has at least one of the allowed roles.
 * @param allowedRoles the roles to check
 * @returns true if the user has at least one of the allowed roles, otherwise false
 */
const useUserAccessControl = allowedRoles => {
  const {
    user
  } = usePortalContext();
...
exports.AccessRestrictionType = void 0;
(function (AccessRestrictionType) {
  AccessRestrictionType["DISABLE"] = "DISABLE";
  AccessRestrictionType["HIDE"] = "HIDE";
})(exports.AccessRestrictionType || (exports.AccessRestrictionType = {}));
const RBAC = ({
  roles,
  restrictionType: _restrictionType = exports.AccessRestrictionType.DISABLE,
  children
}) => {
  const {
    missingRoleMessage
  } = useRBACTranslation();
  const accessGranted = useUserAccessControl(roles);
  if (_restrictionType === exports.AccessRestrictionType.HIDE) return accessGranted ? children : null;
  return jsxRuntime.jsx(DisableFields, {
    rules: [{
      disabled: !accessGranted,
      message: missingRoleMessage(roles)
    }],
    fullWidth: true,
    children: children
  });
...
const salesPortalRoles = {
  ADMIN: 'ADMIN',
  FRONT_OFFICE: 'FRONT_OFFICE',
  PRICING_GAS: 'PRICING_GAS',
  PRICING_POWER: 'PRICING_POWER',
  READ_ONLY: 'READ_ONLY',
  SALES_TRADING: 'SALES_TRADING'
};

const MAX_APP_WIDTH = 1920;
const WidthLimiter = ({
  children,
  maxWidth: _maxWidth = MAX_APP_WIDTH
}) => jsxRuntime.jsx(material.Box, {
  sx: {
    height: '100%',
    width: '100%',
...
var HTTP_REQUEST_TIMEOUT$1 = 10000;

var _excluded$1 = ["tags"];
...
function addTransactionContext(transaction, _temp) {
  var _ref = _temp === void 0 ? {} : _temp;
      _ref.tags;
      var configContext = _objectWithoutPropertiesLoose$1(_ref, _excluded$1);
...
var stackParser = /*@__PURE__*/getDefaultExportFromCjs(errorStackParserExports);
...
var ErrorLogging = function () {
  ...
  _proto.createErrorDataModel = function createErrorDataModel(errorEvent) {
    ...
    var _this$_configService$ = this._configService.get('context');
        _this$_configService$.tags;
        var configContext = _objectWithoutPropertiesLoose(_this$_configService$, _excluded);
...
function sendFetchRequest(method, url, _ref) {
  var _ref$keepalive = _ref.keepalive,
      ...
      timeout = _ref$timeout === void 0 ? HTTP_REQUEST_TIMEOUT$1 : _ref$timeout,
  ...
  var fetchResponse;
  return window.fetch(url, _extends$4({
    body: payload,
    headers: headers,
    method: method,
    keepalive: keepalive,
...
var ApmServer = function () {
  ...
  _proto._makeHttpRequest = function _makeHttpRequest(method, url, _temp) {
    var _ref2 = _temp === void 0 ? {} : _temp,
        ...
        timeout = _ref2$timeout === void 0 ? HTTP_REQUEST_TIMEOUT$1 : _ref2$timeout,
  ...
  _proto.setLocalConfig = function setLocalConfig(config, merge) {
    if (config) {
      if (merge) {
        ...
        config = _extends$3({}, prevConfig, config);
      }
...
var Span = function (_SpanBase) {
  _inheritsLoose$2(Span, _SpanBase);
...
function captureNavigation(transaction) {
  ...
  if (isPerfTimelineSupported()) {
    ...
    var resourceEntries = PERF.getEntriesByType(RESOURCE$1);
...
function getWithTransaction(apm) {
  return function withTransaction(name, type, callback) {
    ...
    return function (Component) {
      ...
      return hoistNonReactStatics$1(ApmComponent, Component);
    };
  };
}
...
function getApmRoutes(apm) {
  function ApmRoutes(props) {
    ...
    React.useLayoutEffect(function () {
      var routes = createRoutesFromChildren(props.children);
  ...
  hoistNonReactStatics$1(ApmRoutes, Routes);
  return ApmRoutes;
}
...
function handleRouteChange(apm, routes, location) {
  ...
  var name = getRouteFromLocation(routes, location);
  ...
  if (branches) {
    for (var index = 0; index < branches.length; index++) {
      ...
      if (route) {
        ...
        if (path) {
          var hasSlash = path[0] === '/' || builtPath[builtPath.length - 1] === '/';
          path = hasSlash ? path : "/" + path;
          builtPath += path;

          if (branch.pathname === location.pathname) {
            var isWildcardRoute = builtPath.slice(-2) === '/*';

            if (getNumberOfUrlSegments(builtPath) !== getNumberOfUrlSegments(branch.pathname) && !isWildcardRoute) {
              return path;
            }
...
const TransactionWrapper = ({
  ...
  const WithTransaction = withTransaction(transactionName, eventType)(component);
  WithTransaction.displayName = `ComponentWithTransaction(${transactionName})`;
  return jsxRuntime.jsx(WithTransaction, {});
};
const ComponentWithTransaction = /*#__PURE__*/React.memo(TransactionWrapper);
...
const SnackbarContext = /*#__PURE__*/React.createContext(undefined);
var ActionType;
(function (ActionType) {
  ActionType["ENQUEUE_SNACKBAR"] = "ENQUEUE_SNACKBAR";
  ActionType["CLOSE_SNACKBAR"] = "CLOSE_SNACKBAR";
...
const SnackbarProvider = _a => {
  ...
  const contextValue = React.useMemo(() => ({
    enqueueSnackbar: (content, options) => {
      var _a;
      const key = (_a = options === null || options === void 0 ? void 0 : options.key) !== null && _a !== void 0 ? _a : generateKey();
      dispatch({
    ...
    closeSnackbar: key => dispatch({
      type: ActionType.CLOSE_SNACKBAR,
      key
    })
  }), []);
  return jsxRuntime.jsx(SnackbarContext, {
    value: contextValue,
    children: jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [children, state.map(({
        key,
        content,
        options
      }) => {
        ...
        const action = (_a = options === null || options === void 0 ? void 0 : options.action) !== null && _a !== void 0 ? _a : jsxRuntime.jsx(material.IconButton, {
          size: "small",
          "aria-label": "close",
          color: "inherit",
          ...
          children: jsxRuntime.jsx(material.Icon, {
            color: "inherit",
            className: "ico-online-close"
          })
        });
        return jsxRuntime.jsx(material.Snackbar, {
          anchorOrigin: (_c = (_b = options === null || options === void 0 ? void 0 : options.anchorOrigin) !== null && _b !== void 0 ? _b : props.anchorOrigin) !== null && _c !== void 0 ? _c : defaultSnackbarOrigin,
          open: true,
          onClose: closeSnackbar,
          action: action,
          autoHideDuration: (_d = options === null || options === void 0 ? void 0 : options.autoHideDuration) !== null && _d !== void 0 ? _d : props.autoHideDuration,
          children: jsxRuntime.jsx(material.Alert, {
            severity: options === null || options === void 0 ? void 0 : options.variant,
            onClose: closeSnackbar,
            action: action,
            children: content
          })
...
const useSnackbar = () => {
  const context = React.use(SnackbarContext);
  if (context === undefined) {
    console.error('useSnackbar can only be used inside of a SnackbarContextProvider!');
    return dummySnackbarContext;
  }
  return context;
};
const generateKey = () => new Date().toISOString() + Math.random().toString(36).replace(/[^a-z]+/g, '').substring(0, 6);

const useDimensions = (elRef, options = {
  fallbackToWindow: true
}) => {
  const getDimensions = React.useCallback(() => {
    var _a, _b;
    return {
      width: ((_a = elRef === null || elRef === void 0 ? void 0 : elRef.current) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().width) || ((options === null || options === void 0 ? void 0 : options.fallbackToWindow) ? window === null || window === void 0 ? void 0 : window.innerWidth : undefined),
      height: ((_b = elRef === null || elRef === void 0 ? void 0 : elRef.current) === null || _b === void 0 ? void 0 : _b.getBoundingClientRect().height) || ((options === null || options === void 0 ? void 0 : options.fallbackToWindow) ? window === null || window === void 0 ? void 0 : window.innerHeight : undefined)
    };
  }, [elRef, options]);
  const [dimensions, setDimensions] = React.useState(getDimensions());
  const handleResize = React.useCallback(() => {
    const newDim = getDimensions();
    if (!lodashExports.isEqual(newDim, dimensions)) {
      setDimensions(newDim);
    }
  }, [dimensions, getDimensions]);
  React.useEffect(() => {
    handleResize();
  }, [elRef, options, handleResize]);
  React.useEffect(() => {
...
exports.ActionPortalsContextProvider = ActionPortalsContextProvider;
exports.ChipAutocomplete = ChipAutocomplete;
exports.ChipAutocompleteProvider = ChipAutocompleteProvider;
exports.ComponentWithTransaction = ComponentWithTransaction;
exports.ConfirmationDialog = ConfirmationDialog;
exports.ConfirmationDialogProvider = ConfirmationDialogProvider;
exports.DisableFields = DisableFields;
exports.DisableFieldsTranslationProvider = DisableFieldsTranslationProvider;
exports.DisabledFormControlTooltip = DisabledFormControlTooltip;
exports.EnumButtonGroup = EnumButtonGroup;
exports.EnumButtonGroupTranslationProvider = EnumButtonGroupTranslationProvider;
exports.EnumSelect = EnumSelect;
exports.EnumSelectTranslationProvider = EnumSelectTranslationProvider;
exports.ErrorBoundary = ErrorBoundary;
exports.NavigationPage = NavigationPage;
exports.PortalContextProvider = PortalContextProvider;
exports.RBAC = RBAC;
exports.RBACTranslationProvider = RBACTranslationProvider;
exports.SnackbarProvider = SnackbarProvider;
exports.WidthLimiter = WidthLimiter;
exports.getActiveDisableRule = getActiveDisableRule;
exports.notDisabled = notDisabled;
exports.salesPortalRoles = salesPortalRoles;
exports.useActionPortals = useActionPortals;
exports.useConfirmationDialog = useConfirmationDialog;
exports.useDimensions = useDimensions;
exports.useDisableFieldsTranslation = useDisableFieldsTranslation;
exports.useNavigationActionAreas = useNavigationActionAreas;
exports.usePortalContext = usePortalContext;
exports.useRBACTranslation = useRBACTranslation;
exports.useSnackbar = useSnackbar;
exports.useUserAccessControl = useUserAccessControl;
exports.userPreferenceHookFactory = userPreferenceHookFactory;
