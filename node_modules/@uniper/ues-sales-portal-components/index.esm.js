...
import React__default, { createContext, use, forwardRef, createElement as createElement$1, useContext, useMemo, useState, useCallback, useEffect, memo, useReducer } from 'react';
import { useTheme, ThemeProvider, Autocomplete, TextField, Chip, Tooltip, Box, createTheme, MenuItem, FormControl, FormLabel, ToggleButtonGroup, ToggleButton, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Button, Paper, List, ListItem, Grid, alpha, Icon, ListItemAvatar, Avatar, ListItemText, Typography, Stack, IconButton, Snackbar, Alert } from '@mui/material';
...
const Context$5 = /*#__PURE__*/createContext(defaultContext$4);
...
const ChipAutocomplete = /*#__PURE__*/forwardRef((props, propRef) => {
  const {
      value = [],
      error,
      chipTypingPattern,
    ...
    otherProps = __rest(props, ["value", "error", "chipTypingPattern", "chipValuePattern", "separatorPattern", "maxChipCount", "onChipClick", "label", "options", "onBeforePaste", "getOptionLabel", "onChange", "freeSolo"]);
  ...
  return jsx(ThemeProvider, {
    theme: theme,
    children: jsx(Autocomplete, Object.assign({}, otherProps, {
      ...
      renderValue: (values, getItemProps) => values.map((option, index) => {
        ...
        return /*#__PURE__*/createElement$1(Chip, Object.assign({
...
const Context$4 = /*#__PURE__*/createContext(defaultContext$3);
const EnumSelectTranslationProvider = ({
  translation,
  children
}) => jsx(Context$4.Provider, {
  value: {
    translation
  },
  children: children
...
const useEnumSelect = () => {
  const context = useContext(Context$4);
...
const Context$3 = /*#__PURE__*/createContext(defaultValue);
...
const DisabledFieldsContext = /*#__PURE__*/createContext({
  activeRule: null
});
const DisabledFieldsContextProvider = ({
  ...
  return jsx(DisabledFieldsContext, {
    value: {
      activeRule
    },
    children: children
...
const useDisabledFieldContext = () => use(DisabledFieldsContext);
...
const DisableFields = ({
  ...
  return jsx(ThemeProvider, {
    theme: disabledTheme,
    children: jsx(DisabledFieldsContextProvider, {
...
const disabledThemeFactory = theme => {
  const disabledTheme = createTheme(theme);
...
const getComponentConfig = (componentName, theme) => {
  var _a;
  return ((_a = theme.components) === null || _a === void 0 ? void 0 : _a[componentName]) || {};
};
const getComponentDefaultProps = (componentName, theme) => getComponentConfig(componentName, theme).defaultProps || {};
const disableComponent = (componentName, theme) => ({
  [componentName]: Object.assign(Object.assign({}, getComponentConfig(componentName, theme)), {
    defaultProps: Object.assign(Object.assign({}, getComponentDefaultProps(componentName, theme)), {
      disabled: true
    })
  })
});
const useDisabledTheme = theme => {
  return useMemo(() => disabledThemeFactory(theme), [theme]);
};
...
const EnumSelectComponent = (_a, ref) => {
  var {
    ...
    otherProps = __rest(_a, ["value", "onChange", "enumName", "enumType", "emptyOption", "disabledOptions", "disabled", "renderOption"]);
  const {
    translation: {
      atMostOneEnumMessage,
      defaultRenderItem
  ...
  return jsx(ThemeProvider, {
    ...
    children: jsx(DisableFields, {
      ...
      children: jsxs(TextField, Object.assign({
        ...
        children: [emptyOption && jsx(MenuItem, {
          value: "",
          children: "-"
        }), Object.entries(enumType).map(([key, value]) => jsx(MenuItem, {
          value: value,
...
const EnumSelect = /*#__PURE__*/forwardRef(EnumSelectComponent);
...
const Context$2 = /*#__PURE__*/createContext(defaultContext$2);
const EnumButtonGroupTranslationProvider = ({
  translation,
  children
}) => jsx(Context$2.Provider, {
  value: {
    translation
  },
  children: children
...
const EnumButtonGroupComponent = (_a, ref) => {
  var {
    ...
    otherProps = __rest(_a, ["label", "value", "onChange", "enumName", "enumType", "disabledOptions", "autoFocus"]);
  const {
    translation: {
      enumsPrefixTranslations
    }
  ...
  return jsxs(FormControl, {
    fullWidth: true,
    children: [label && jsx(FormLabel, {
      children: label
    }), jsx(ToggleButtonGroup, Object.assign({}, otherProps, {
      fullWidth: true,
      exclusive: true,
      ref: ref,
      value: value,
...
const EnumButtonGroup = /*#__PURE__*/forwardRef(EnumButtonGroupComponent);
...
const ConfirmationDialogContext = /*#__PURE__*/createContext({
  doOpen: noop$2
});
const ConfirmationDialogProvider = ({
  ...
  const [config, setConfig] = useState(emptyConfirmationDialogProps);
  const doOpen = config => {
    setConfig(config);
    setOpen(true);
  };
  return jsxs(ConfirmationDialogContext, {
    value: {
      doOpen
    },
    children: [jsx(ConfirmationDialog, Object.assign({}, config, {
      open: open,
      onConfirm: () => {
        config.onConfirm();
        setOpen(false);
...
const DisabledFormControlTooltip = _a => {
  var {
    ...
    rest = __rest(_a, ["children", "rules", "fullWidth"]);
  const {
    activeRule: parentActiveRule
  } = useDisabledFieldContext();
  if (parentActiveRule) return children;
  const activeRule = getActiveDisableRule(rules);
  return activeRule ? jsx(DisabledFieldsContextProvider, {
    activeRule: activeRule,
...
const Context$1 = /*#__PURE__*/createContext(defaultContext$1);
...
const usePortalContext = () => {
  const portalContext = use(Context$1);
...
const ErrorBoundary = ({
  ...
  return jsx(CustomErrorBoundaryComponent, {
    services: services,
    children: children
  });
};
class CustomErrorBoundaryComponent extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return this.state.hasError ? jsx(Box, {
      sx: {
        margin: 'auto',
        userSelect: 'none',
        fontSize: '42px',
      ...
      children: jsxs("div", {
        children: [jsx(Box, {
          ...
          children: ["Oops \u2026 something went ", jsx("b", {
            children: "t-rex"
          }), "ibly wrong."]
        })]
      })
...
const userPreferenceHookFactory = (version = 1, transformers = []) => (preferenceName, defaultValue) => {
  ...
  const setPreference = useCallback(value => userPreferences.updatePreferences(previous => ({
    version,
  ...
  const clearPreference = useCallback(() => userPreferences.updatePreferences(previous => {
    var _a;
    const _b = (_a = previous === null || previous === void 0 ? void 0 : previous.preferences) !== null && _a !== void 0 ? _a : {},
      _c = preferenceName;
      _b[_c];
      const otherPreferences = __rest(_b, [typeof _c === "symbol" ? _c : _c + ""]);
    return {
      version,
...
const DynamicPortal = ({
  ...
  return jsx(Fragment, {
    children: /*#__PURE__*/createPortal(children, container)
  });
};
...
const ActionPortalsContext = /*#__PURE__*/createContext({
...
const useActionPortals = () => use(ActionPortalsContext);

const ActionRefContext = /*#__PURE__*/createContext({
  primaryRef: () => () => {
    // empty
  },
  secondaryRef: () => () => {
...
const ActionRefContextProvider = ({
  ...
  const primaryRef = useCallback(node => {
    setPrimary(node);
    return () => setPrimary(null);
  }, []);
  const secondaryRef = useCallback(node => {
    setSecondary(node);
    return () => setSecondary(null);
  }, []);
  return jsx(ActionRefContext, {
    value: {
      primaryRef,
      secondaryRef,
...
const useActionRefContext = () => use(ActionRefContext);
...
const NavigationLayout = ({
  ...
  children: jsx(Box, {
    ...
    children: jsx(ActionRefContextProvider, {
      children: children
    })
  })
});
...
const NavigationHeader = ({
  ...
  return jsxs(Fragment, {
    children: [(appIcon || appName || status) && jsx(ListItem, {
      sx: theme => ({
      ...
      children: jsxs(Grid, {
        ...
        children: [jsxs(Grid, {
          ...
          alignItems: "center",
          spacing: 1,
          children: [appIcon && jsx(Grid, {
            children: jsx(DisplayIcon, {
              appIcon: appIcon,
              appIconColor: appIconColor
            })
          }), jsx(Grid, {
            children: jsx(WithBackdrop, {
              children: jsxs(Grid, {
                container: true,
                alignItems: "center",
                spacing: 1,
                children: [jsx(Grid, {
                  children: appName
                }), showAsTooltip && additionalInfo && jsx(Grid, {
                  children: jsx(AdditionalInfoTooltip, {
    ...
    }), !showAsTooltip && additionalInfo && jsx(Box, {
      sx: theme => ({
        paddingTop: theme.spacing(2)
      }),
      children: jsx(NavigationPage.Item, {
        children: additionalInfo
      })
    })]
  });
...
const WithBackdrop = ({
  ...
  sx: theme => ({
    color: 'white',
    backgroundColor: alpha(theme.palette.grey.A200, 0.15),
...
const NavigationItemContext = /*#__PURE__*/createContext(undefined);
const NavigationItemProvider = ({
  children,
  isActive
}) => {
  const parentContext = use(NavigationItemContext);
  return jsx(NavigationItemContext, {
    value: {
      isActive,
...
const useNavigationItemContext = () => {
  const context = use(NavigationItemContext);
...
const NavigationItem = ({
  ...
  children: jsx(NavigationItemProvider, {
    isActive: _isActive,
    children: children
  })
});
...
const MainPanel = ({
  ...
  return jsx(Box, {
    ...
    children: jsx(ActionPortalsContextProvider, {
...
const RBAC = ({
  roles,
  restrictionType: _restrictionType = AccessRestrictionType.DISABLE,
  children
}) => {
  const {
    missingRoleMessage
  ...
  if (_restrictionType === AccessRestrictionType.HIDE) return accessGranted ? children : null;
  return jsx(DisableFields, {
    rules: [{
...
function getWithTransaction(apm) {
  return function withTransaction(name, type, callback) {
    ...
    return function (Component) {
      ...
      if (!isReactClassComponent(Component) && typeof React__default.useEffect === 'function' && typeof React__default.useState === 'function') {
...
const TransactionWrapper = ({
  ...
  return jsx(WithTransaction, {});
};
const ComponentWithTransaction = /*#__PURE__*/memo(TransactionWrapper);
  ...
  return jsx(SnackbarContext, {
    ...
    children: jsxs(Fragment, {
      children: [children, state.map(({
        ...
        const action = (_a = options === null || options === void 0 ? void 0 : options.action) !== null && _a !== void 0 ? _a : jsx(IconButton, {
          size: "small",
          "aria-label": "close",
          color: "inherit",
...
export { AccessRestrictionType, ActionPortalsContextProvider, ChipAutocomplete, ChipAutocompleteProvider, ComponentWithTransaction, ConfirmationDialog, ConfirmationDialogProvider, DisableFields, DisableFieldsTranslationProvider, DisabledFormControlTooltip, EnumButtonGroup, EnumButtonGroupTranslationProvider, EnumSelect, EnumSelectTranslationProvider, ErrorBoundary, NavigationPage, PortalContextProvider, RBAC, RBACTranslationProvider, SnackbarProvider, WidthLimiter, getActiveDisableRule, notDisabled, salesPortalRoles, useActionPortals, useConfirmationDialog, useDimensions, useDisableFieldsTranslation, useNavigationActionAreas, usePortalContext, useRBACTranslation, useSnackbar, useUserAccessControl, userPreferenceHookFactory };
