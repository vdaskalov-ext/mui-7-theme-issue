...
var locales = require('@mui/x-data-grid-pro/locales');
var locales$1 = require('@mui/x-date-pickers-pro/locales');
var React = require('react');
var jsxRuntime = require('react/jsx-runtime');
var xDataGridPro = require('@mui/x-data-grid-pro');
var xDataGridPremium = require('@mui/x-data-grid-premium');
...
const ArrowIcon = props => {
  return /*#__PURE__*/jsxRuntime.jsx(material.Icon, {
    className: `${props.className} ico-arrows-simple-arrow-down`,
    color: "inherit"
  });
};
const ClearIcon = () => {
...
let _ = t => t,
  _t;
const spin = material.keyframes(_t || (_t = _`
from {
...
const LoadingSpinner = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(material.Box, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(material.Icon, {
      className: `ico-online-loading`,
      color: 'inherit'
    })
  });
};
...
const px = n => `${n}px`;
const rem = n => `${n}rem`;
const FontName = 'DIN Next W01';
const FontFamily = `"${FontName}", Helvetica, Arial, sans-serif`;
const FontSize = {
  small: rem(0.875),
  medium: rem(1),
  large: rem(1.125),
...
const h1 = palette => Object.assign({}, commonHStyle(palette), {
  fontSize: '22px',
  lineHeight: '26px'
});
const h2 = palette => Object.assign({}, commonHStyle(palette), {
  fontSize: '20px',
  lineHeight: '24px'
});
const h3 = palette => Object.assign({}, commonHStyle(palette), {
  fontSize: '18px',
  lineHeight: '22px'
});
const hStyles = palette => ({
  h1: h1(palette),
  h2: h2(palette),
  h3: h3(palette),
...
const typography = palette => Object.assign({
  fontFamily: FontFamily,
...
const componentsFactory = container => {
  ...
  const commonMuiDefaultRowSpacing = {
    xs: 0.5,
    sm: 0.5,
    md: 1,
    lg: 2,
  ...
  const commonMuiDefaultColumnSpacing = {
    xs: 0.5,
    sm: 1,
    md: 2,
    lg: 3,
  ...
  const commonToogleButtonStyles = Object.assign({}, commonButtonStyles, {
    paddingTop: `${px(5)}`,
    paddingBottom: `${px(5)}`
  });
  return {
    MuiTextField: {
      defaultProps: Object.assign({}, commonMuiDefaultProps)
    },
    MuiInputLabel: {
      defaultProps: {
        size: 'small'
      ...
      styleOverrides: {
        outlined: ({
          ...
          var _ownerState$formContr;
          return ownerState != null && (_ownerState$formContr = ownerState.formControl) != null && _ownerState$formContr.disabled ? {
    ...
    MuiSelect: {
      ...
      styleOverrides: {
        icon: ({
          ...
          if (ownerState != null && ownerState.disabled) {
            color = makeImportant(theme.palette.text.disabled);
          } else if (ownerState != null && ownerState.error || (ownerState == null ? void 0 : ownerState.color) === 'error') {
    ...
    MuiOutlinedInput: {
      styleOverrides: {
        input: ({
          ...
          userSelect: ownerState != null && ownerState.disabled ? 'auto' : 'none'
        })
      }
    },
    MuiIcon: {
      defaultProps: {
        baseClassName: 'uniper-icons',
        color: 'primary',
        fontSize: 'small'
      },
      styleOverrides: {
    ...
    MuiAutocomplete: {
      defaultProps: Object.assign({}, commonMuiDefaultProps, {
        clearIcon: /*#__PURE__*/jsxRuntime.jsx(ClearIcon, {}),
        popupIcon: /*#__PURE__*/jsxRuntime.jsx(ArrowIcon, {}),
        loadingText: /*#__PURE__*/jsxRuntime.jsx(LoadingSpinner, {})
      }),
      styleOverrides: {
        noOptions: ({
          ownerState,
          ...
          if (ownerState != null && ownerState.error || (ownerState == null ? void 0 : ownerState.color) === 'error') {
            return {
              color: theme.palette.error.main
            };
          }
    ...
    MuiList: {
      styleOverrides: {
        root: {
          backgroundColor: makeImportant('inherit')
        }
      }
    },
    MuiIconButton: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: Object.assign({}, commonButtonStyles)
      }
    },
    MuiButtonGroup: {
      defaultProps: {
    ...
    MuiTooltip: {
      defaultProps: {
        color: 'primary',
        TransitionComponent: material.Zoom,
        placement: 'right',
        followCursor: true
      },
      styleOverrides: {
        tooltip: ({
          ...
          if ((ownerState == null ? void 0 : ownerState.color) === 'error') {
            return {
              backgroundColor: theme.palette.error.main
            };
          } else if ((ownerState == null ? void 0 : ownerState.color) === 'warning') {
            return {
              backgroundColor: theme.palette.warning.main
            };
          } else if ((ownerState == null ? void 0 : ownerState.color) === 'primary') {
            return {
    ...
    MuiChip: {
      defaultProps: {
        size: 'medium',
        variant: 'outlined',
        deleteIcon: /*#__PURE__*/jsxRuntime.jsx(material.Icon, {
          className: "ico-misc-circle-cancel",
          color: "inherit",
          fontSize: "small"
        })
    ...
    MuiAccordionSummary: {
      defaultProps: {
        expandIcon: /*#__PURE__*/jsxRuntime.jsx(material.Icon, {
          className: "ico-arrows-arrow-circle-down"
        })
      }
    },
    MuiAppBar: {
    ...
    MuiStack: {
      defaultProps: {
        spacing: commonMuiDefaultRowSpacing
      }
    },
    MuiGrid: {
      defaultProps: {
    ...
    MuiCard: {
      variants: [{
        ...
        style: ({
          ...
          backgroundColor: theme.palette.uniper.card.backgroundColor,
    ...
    MuiToggleButton: {
      styleOverrides: {
        root: ({
          ...
          ownerState
        }) => ownerState.disabled ? Object.assign({}, commonToogleButtonStyles) : ownerState.selected ? Object.assign({}, commonToogleButtonStyles, {
          color: makeImportant(palette.common.white),
          borderColor: palette.primary.main,
          backgroundColor: makeImportant(palette.primary.main)
        }) : ownerState.color === 'error' ? Object.assign({}, commonToogleButtonStyles, {
          color: palette.error.main,
          borderColor: palette.error.main
        }) : Object.assign({}, commonToogleButtonStyles, {
    ...
    MuiCssBaseline: {
      styleOverrides: theme => {
        ...
        return Object.assign({
          html: Object.assign({}, commonGlobalStyle),
          body: Object.assign({}, commonGlobalStyle, {
          ...
          nav: {
            backgroundColor: theme.palette.uniper.navigation.backgroundColor
          }
        });
      }
    }
...
const initMuiXDataGridProLicense = () => {
  LicenseInfo.setLicenseKey('13ca0eaa31fd6a46f08b7558b2b4dc9fTz0xMDc1MjQsRT0xNzc0OTcyODAwMDAwLFM9cHJlbWl1bSxMTT1zdWJzY3JpcHRpb24sUFY9UTMtMjAyNCxLVj0y');
};
const DataGridLicenseProvider = ({
  children
}) => {
  ...
  return initialized ? /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: children
  }) : null;
};
...
let Themes = /*#__PURE__*/function (Themes) {
  Themes["UNIPER_LIGHT"] = "uniper-light";
  Themes["UNIPER_DARK"] = "uniper-dark";
  Themes["ORANGE_LIGHT"] = "orange-light";
  Themes["ORANGE_DARK"] = "orange-dark";
  Themes["GREEN_LIGHT"] = "green-light";
  Themes["GREEN_DARK"] = "green-dark";
  return Themes;
}({});
...
const isDarkTheme = theme => theme.endsWith(ThemeMode.DARK);
const inMode = (theme, mode) => mode === ThemeMode.DARK ? theme.replace(ThemeMode.LIGHT, ThemeMode.DARK) : theme.replace(ThemeMode.DARK, ThemeMode.LIGHT);
let ThemeLanguage = /*#__PURE__*/function (ThemeLanguage) {
  ThemeLanguage["EN"] = "en";
  ThemeLanguage["DE"] = "de";
...
const _colorsByTheme = {
  [Themes.UNIPER_LIGHT]: primaryBlue,
  [Themes.UNIPER_DARK]: primaryBlue,
...
Object.assign({}, defaultColors, primaryBlue);
const _themeColors = theme => Object.assign({}, defaultColors, _colorsByTheme[theme]);
  ...
  return Object.assign({}, basePalette, {
    ...
    uniper: {
      navigation: {
        ...
        active: (_basePalette$common = basePalette.common) == null ? void 0 : _basePalette$common.white
      },
      card: {
...
const darkPalette = colors => Object.assign({}, basePalette, {
  mode: 'dark',
  primary: {
    light: colors.primary100,
    main: colors.primary500,
...
const paletteFactory = theme => isDarkTheme(theme) ? darkPalette(themeColors(theme)) : lightPalette(themeColors(theme));

const UniperThemeProvider = ({
  theme,
  language,
  container,
  children
}) => {
  const muiTheme = React.useMemo(() => themeFactory({
    theme,
    container,
    language
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(material.ThemeProvider, {
    theme: muiTheme,
    children: [/*#__PURE__*/jsxRuntime.jsx(material.CssBaseline, {}), /*#__PURE__*/jsxRuntime.jsx(DataGridLicenseProvider, {
      children: children
    })]
  }, `${theme}-${language}`);
};
...
const de = [locales.deDE, locales$1.deDE, locale.deDE];
const en = [locales.enUS, locales$1.enUS, locale.enUS];
...
const StyledDataGridPro = material.styled(xDataGridPro.DataGridPro)(() => ({
  fontSize: '1rem'
}));

const StyledDataGridPremium = material.styled(xDataGridPremium.DataGridPremium)(() => ({
  fontSize: '1rem'
}));

exports.LoadingSpinner = LoadingSpinner;
exports.SnackbarOptions = SnackbarOptions;
exports.StyledDataGridPremium = StyledDataGridPremium;
exports.StyledDataGridPro = StyledDataGridPro;
exports.ThemeLanguage = ThemeLanguage;
exports.ThemeMode = ThemeMode;
exports.Themes = Themes;
exports.UniperThemeProvider = UniperThemeProvider;
exports.inMode = inMode;
