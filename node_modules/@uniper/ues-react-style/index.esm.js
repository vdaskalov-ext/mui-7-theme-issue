import { Icon, useTheme, keyframes, Box, Zoom, ThemeProvider, CssBaseline, createTheme, styled } from '@mui/material';
import { deDE as deDE$2, enUS as enUS$2 } from '@mui/material/locale';
import { deDE, enUS } from '@mui/x-data-grid-pro/locales';
import { deDE as deDE$1, enUS as enUS$1 } from '@mui/x-date-pickers-pro/locales';
...
const componentsFactory = container => {
  ...
  const commonToggleButtonStyles = Object.assign({}, commonButtonStyles, {
    paddingTop: `${px(5)}`,
    paddingBottom: `${px(5)}`
  });
  return {
    ...
    MuiAutocomplete: {
      defaultProps: Object.assign({}, commonMuiDefaultProps, {
        ...
        popupIcon: /*#__PURE__*/jsx(ArrowIcon, {}),
        loadingText: /*#__PURE__*/jsx(LoadingSpinner, {})
      }),
      styleOverrides: {
        noOptions: ({
          ownerState,
    ...
    MuiToggleButton: {
      styleOverrides: {
        root: ({
          ...
          ownerState
        }) => ownerState.disabled ? Object.assign({}, commonToggleButtonStyles) : ownerState.selected ? Object.assign({}, commonToggleButtonStyles, {
          color: makeImportant(palette.common.white),
          borderColor: palette.primary.main,
          backgroundColor: makeImportant(palette.primary.main)
        }) : ownerState.color === 'error' ? Object.assign({}, commonToggleButtonStyles, {
          color: palette.error.main,
          borderColor: palette.error.main
        }) : Object.assign({}, commonToggleButtonStyles, {
...
const DataGridLicenseProvider = ({
  ...
  return initialized ? /*#__PURE__*/jsx(Fragment, {
    children: children
  }) : null;
};
...
const UniperThemeProvider = ({
  ...
  const muiTheme = useMemo(() => themeFactory({
    theme,
    container,
    language
  ...
  return /*#__PURE__*/jsxs(ThemeProvider, {
    theme: muiTheme,
    children: [/*#__PURE__*/jsx(CssBaseline, {}), /*#__PURE__*/jsx(DataGridLicenseProvider, {
      children: children
    })]
  }, `${theme}-${language}`);
};
...
const de = [deDE, deDE$1, deDE$2];
const en = [enUS, enUS$1, enUS$2];
...
export { LoadingSpinner, SnackbarOptions, StyledDataGridPremium, StyledDataGridPro, ThemeLanguage, ThemeMode, Themes, UniperThemeProvider, inMode, isDarkTheme };
